...
from .compute_u import compute_u, compute_u_k_and_v
from .compute_v import compute_v, compute_v_k_and_v
...
def apply_rome_to_model_k_and_v(
    model: AutoModelForCausalLM,
    tok: AutoTokenizer,
    requests: List[Dict],
    hparams: ROMEHyperParams,
    ...
    print("sanity: apply_rome_to_model_k_and_v")
